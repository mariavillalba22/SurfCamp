...
public class Delete {
   ...
   public void deleteMaterialfromCMbyN (Material mat) throws SQLException {
		String sql = "DELETE FROM camper_material WHERE id_material = ?";
		PreparedStatement prep  = c.prepareStatement(sql);
...
public void deleteActivityfromCMbyN (Activity act) throws SQLException {
	String sql = "DELETE FROM camper_activity WHERE id_activity = ?";
	PreparedStatement prep  = c.prepareStatement(sql);
...
public void deleteActivityN (Activity act) throws SQLException {
